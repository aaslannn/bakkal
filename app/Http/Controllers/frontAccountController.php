...
class frontAccountController extends FrontController
{
    ...
    public function getProfile()
    {
        ...
        return View('uye.profil',compact('uye','countries'));
    }
    ...
    public function postProfile()
    {
        ...
        if(Input::get('_islem') == 'editProfile')
        {
            ...
            $uye->country   = Input::get('country');
            $uye->state   = Input::get('state');
            $uye->city   = Input::get('city');
            $uye->town   = Input::get('town');
    ...
    public function getEditAddress($id)
    {
        ...
        return View('uye/adres-duzenle', compact('adres','uye','countries'));
    }
