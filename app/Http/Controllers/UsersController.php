...
class UsersController extends MainController
{
    ...
    public function getCreate()
    {
        ...
        if (Sentry::getUser()->hasAccess('admin')) {
            $groups = Sentry::getGroupProvider()->findAll(); //all groups
        }
        else if(Sentry::getUser()->hasAccess('users_edit')) {
            $groups = Group::where('name','!=','SuperAdmin')->get();
        }
        else {
            return Redirect::to('/admin/users')->with('error', Lang::get('general.nopermission'));
        }
    ...
    public function getEdit($id = null)
    {
        try {
            ...
            $userGroups = $user->groups()->lists('name', 'group_id')->all();
        ...
        $userGroup = $user->groups()->lists('name')->first(); //SuperAdmin
        if (!Sentry::getUser()->hasAccess('admin') && $userGroup == 'SuperAdmin') //if this user is superadmin, but you are not.
            return Redirect::to('/admin/users')->with('error', Lang::get('general.nopermission'));
    ...
    public function postEdit($id = null)
    {
        ...
        try {
            ...
            $userGroups = $user->groups()->lists('group_id', 'group_id')->all();
    ...
    public function changePass($id = null)
    {
        ...
        unset($this->validationRules['first_name']);
        unset($this->validationRules['last_name']);
        unset($this->validationRules['email']);
        unset($this->validationRules['pic']);
        ...
        // Redirect to the user page
        return Redirect::route('users.show', $id)->withInput()->with('error', $error);
    }
