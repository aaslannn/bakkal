...
class frontOrdersController extends FrontController
{
    ...
    public function index($url)
    {
        ...
        if($url == 'teslimat')
        {
            ...
            return View('siparis.teslimat',compact('user','countries','tadresler','fadresler','cargos'));
        }
        if($url == 'odeme')
        {
            if(Cart::total() == 0)
    ...
    public function saveOrder($url)
    {
        ...
        {            
            ...
            if($inputs['faturaAyni'] == 0)
            {
                $rules = array(
                    ...
                    'tel'     => 'required',
                    'fisim'     => 'required',
                    'fcountry'     => 'required|numeric|min:1',
                    'fcity'     => 'required',
                    'ftown'     => 'required',
                    'faddress'     => 'required',
                    'ftel'     => 'required',
        ...
        if($url == 'odeme')
        {
            ...
            if($data['faturaAyni'] == 1)
            {
                ...
                $data['fcountry_id'] = $order['country'];
                $data['fstate'] = $order['state'];
                $data['fcity_id'] = $order['city'];
            ...
            else
            {
                ...
                $data['fcountry_id'] = $order['fcountry'];
                $data['fstate'] = $order['fstate'];
                $data['fcity_id'] = $order['fcity'];
