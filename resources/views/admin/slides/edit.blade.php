                        ...
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            @foreach($langs as $lang)
                                ...
                                <div class="form-group {{ $errors->first($degisken, 'has-error') }}">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" id="{{ $degisken }}" name="{{ $degisken }}" class="form-control" placeholder="" value="{{{ Input::old($degisken, $slide->$degisken)  }}}">
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="col-sm-5">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 878px; height: 393px;">
                                            @if($slide->image)
                                                <img src="{{{ url('/').'/uploads/slides/'.$slide->image }}}" alt="image">
                                            @else
                            ...
                            <div class="form-group {{ $errors->first('link', 'has-error') }}">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" id="link" name="link" class="form-control" placeholder="" value="{{{ Input::old('link', $slide->link) }}}">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group {{ $errors->first('sequence', 'has-error') }}">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" id="sequence" name="sequence" class="form-control" placeholder="" value="{{{ Input::old('sequence', $slide->sequence) }}}">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group {{ $errors->first('status', 'has-error') }}">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control" id="status" name="status">
                                        <option value="1" @if($slide->status === 1) selected="selected" @endif>Aktif</option>
                                        <option value="0" @if($slide->status === 0) selected="selected" @endif>Pasif</option>
                                    </select>
                                </div>
                                <div class="col-sm-2">
