...
{{-- Web site Title --}}
@section('title') @lang('bankaccounts/title.create')  @parent @stop
...
<section class="content-header">
    <h1>
        @lang('bankaccounts/title.create')
    </h1>
    <ol class="breadcrumb">
        <li>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->first('bankaAdi', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="bankaAdi" name="bankaAdi" class="form-control" placeholder="" value="{{{ Input::old('bankaAdi') }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('hesapTuru', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="hesapTuru" name="hesapTuru" class="form-control" placeholder="" value="{{{ Input::old('hesapTuru') }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('hesapAdi', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="hesapAdi" name="hesapAdi" class="form-control" placeholder="" value="{{{ Input::old('hesapAdi') }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('iban', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="iban" name="iban" class="form-control IBAN" placeholder="____ ____ ____ ____ ____ ____ __" value="{{{ Input::old('iban') }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('subeAdi', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="subeAdi" name="subeAdi"  class="form-control" placeholder="" value="{{{ Input::old('subeAdi') }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('subeKodu', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="subeKodu" name="subeKodu" class="form-control" placeholder="" value="{{{ Input::old('subeKodu') }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('hesapNo', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="hesapNo" name="hesapNo"  maxlength="30" class="form-control" placeholder="" value="{{{ Input::old('hesapNo') }}}">
                            </div>
                            <div class="col-sm-4">
