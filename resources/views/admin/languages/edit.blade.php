...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('languages/title.edit')</li>
    </ol>
</section>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->first('dil', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="dil" name="dil" class="form-control" placeholder="" value="{{{ Input::old('dil', $language->dil) }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('kisaltma', 'has-error') }}">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="kisaltma" name="kisaltma" class="form-control" placeholder="" value="{{{ Input::old('kisaltma', $language->kisaltma) }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('durum', 'has-error') }}">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" id="durum" name="durum">
                                    <option value="1" @if($language->durum === 1) selected="selected" @endif>Aktif</option>
                                    <option value="0" @if($language->durum === 0) selected="selected" @endif>Pasif</option>
                                </select>
                            </div>
                            <div class="col-sm-2">
