...
{{-- Web site Title --}}
@section('title') @lang('socials/title.create')  @parent @stop
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group {{ $errors->first('icon', 'has-error') }}">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" id="icon" name="icon" class="form-control" placeholder="" value="{{{ Input::old('icon') }}}">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group {{ $errors->first('link', 'has-error') }}">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" id="link" name="link" class="form-control" placeholder="ör: http://www.link.com" value="{{{ Input::old('link') }}}">
                                </div>
                                <div class="col-sm-4">
