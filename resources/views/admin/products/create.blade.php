                    ...
                    <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="col-md-7">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control required" required id="cat_id" name="cat_id">
                                            ...
                                            @foreach($categories as $cat)
                                                <option value="{{ $cat->id }}" @if($cat->id == Input::old('cat_id')) selected="selected" @endif><strong>{{ $cat->title_en }}</strong></option>
                                                @if($cat->subcats()->count() > 0)
                                                    <?php $subcats = $cat->subcats()->get(); ?>
                                                    @foreach($subcats as $subcat)
                                                        <option value="{{ $subcat->id }}" @if($subcat->id == Input::old('cat_id')) selected="selected" @endif> &nbsp;&nbsp;&nbsp; &raquo; {{ $subcat->title_en }}</option>
                                                        <?php $subcats2 = $subcat->subcats()->get(); ?>
                                                        @foreach($subcats2 as $subcat2)
                                                            <option value="{{ $subcat2->id }}" @if($subcat2->id == Input::old('cat_id')) selected="selected" @endif> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &raquo; {{ $subcat2->title_en }}</option>
                                                        @endforeach
                                                    @endforeach
                                                @endif
                                            @endforeach
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" id="brand_id" name="brand_id">
                                        ...
                                        @foreach($brands as $brand)
                                            <option value="{{ $brand->id }}" {{ $brand->id == Input::old('brand_id') ? 'selected="selected"' : '' }}>{{ $brand->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-sm-4">
                            ...
                            @foreach($langs as $lang)
                                <div class="form-group {{ $errors->first('content_'.$lang->kisaltma, 'has-error') }}">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="ckeditor_full" name="content_{{ $lang->kisaltma }}">{{{ Input::old('content_'.$lang->kisaltma) }}}</textarea>
                                    </div>
                                </div>
                            @endforeach
                            <div class="form-group {{ $errors->first('catalog', 'has-error') }}">
                                ...
                                <div class="col-sm-4"> {!! $errors->first('catalog', '<span class="help-block">:message</span> ') !!}</div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group {{ $errors->first('price', 'has-error') }}">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="price" name="price" class="form-control required PriceFormat" required placeholder="" value="{{{ Input::old('price') }}}">
                                    </div>
                                </div>
                            ...
                            <div class="form-group {{ $errors->first('discount_price', 'has-error') }}" id="DiscountedPrice">
                                ...
                                <div class="col-sm-2">  <span class="help-block">ör: 1230,50</span>
                        ...
                        <div class="form-group {{ $errors->first('currency', 'has-error') }}">
                            ...
                            <div class="form-group {{ $errors->first('kargo_ucret', 'has-error') }}">
                                ...
                                <div class="col-sm-2"> <span class="help-block">ör: 6,50</span>
                            ...
                            <div class="form-group {{ $errors->first('images', 'has-error') }}">
                                ...
                                <div class="col-sm-5"> <span class="help-block"><strong>CTRL</strong> ile maks. 5 görsel ekleyebilirsiniz.</span>
                            ...
                            <p class="text-danger"><strong>Ürün Fotoğrafı Yüklerken Dikkat Etmeniz Gerekenler:</strong>
                                ...
                                <li>Ekleyebileceğiniz Görsel Sayısı : <strong>5</strong></li>
