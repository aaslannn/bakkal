...
{{-- Web site Title --}}
@section('title') @lang('translations/title.create')  @parent @stop
...
<section class="content-header">
    <h1>
        @lang('translations/title.create')
    </h1>
    <ol class="breadcrumb">
        <li>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->first('slug', 'has-error') }}">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="slug" name="slug" required="required" class="form-control" placeholder="" value="{{{ Input::old('slug') }}}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        @foreach($langs as $lang)
                            <div class="form-group {{ $errors->first('lang_'.$lang->kisaltma, 'has-error') }}">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" id="lang_{{ $lang->kisaltma }}" name="lang_{{ $lang->kisaltma }}" class="form-control" placeholder="" value="{{{ Input::old('lang_'.$lang->kisaltma) }}}">
                                </div>
                                <div class="col-sm-4">
