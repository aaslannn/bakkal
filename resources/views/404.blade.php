...
<head>
    ...
    <title>{{Lang::get('frontend/general.notfoundtitle')}}</title>
...
<body>
    ...
    <div class="hgroup">
        ...
        <h2>{{Lang::get('frontend/general.pagenotfound')}}</h2>
        <a href="{{ route('home') }}">
            <button type="button" class="btn btn-primary button-alignment">{{Lang::get('frontend/general.home')}}</button>
        </a>
    </div>
    <!-- global js -->
